...
from spert.semi_trainer import SpERTTrainer
...
def __train(run_args):
    ...
    trainer.train(train_path=run_args.train_path, valid_path=run_args.valid_path,
                  types_path=run_args.types_path, unlabeled_path=run_args.unlabeled_path, input_reader_cls=input_reader.JsonInputReader)
